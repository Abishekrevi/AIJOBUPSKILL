...
import { TrendingUp, Award, MessageCircle, Building2, ArrowRight, CheckCircle } from 'lucide-react';
    ...
    <div>
      ...
      <div style={{ marginBottom: 28 }}>
        ...
        <p style={{ color: 'var(--gray-600)', marginTop: 4 }}>
          Here's your transition overview.
        </p>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 14, marginBottom: 28 }}>
        {[
          { icon: MessageCircle, label: 'Chat with AI Coach', sub: 'Get personalised guidance', to: '/coach', color: 'var(--brand)', bg: 'var(--brand-light)' },
          ...
          <button key={to} onClick={() => navigate(to)} style={{
            ...
            padding: '18px 16px', textAlign: 'left', transition: 'transform 0.15s, box-shadow 0.15s',
            cursor: 'pointer'
          }}
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20 }}>
        ...
        {/* Roadmap */}
        <div style={{ background: '#fff', border: '1px solid var(--gray-200)', borderRadius: 12, padding: 22 }}>
          <h3 style={{ fontWeight: 600, fontSize: 15, marginBottom: 16 }}>Your AI roadmap</h3>
          {roadmap ? (
            <div>
